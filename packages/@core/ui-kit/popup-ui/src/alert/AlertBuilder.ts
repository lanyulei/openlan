...
import { Input, OpenLanRenderContent } from '@vben-core/shadcn-ui';
...
export function openlanAlert(options: AlertProps): Promise<void>;
export function openlanAlert(
  message: string,
...
export function openlanConfirm(options: AlertProps): Promise<void>;
export function openlanConfirm(
  message: string,
  options?: Partial<AlertProps>,
): Promise<void>;
export function openlanConfirm(
...
export function openlanConfirm(
  ...
  if (!arg1) {
    return isString(arg0)
      ? openlanAlert(arg0, defaultProps)
      : openlanAlert({ ...defaultProps, ...arg0 });
  } else if (!arg2) {
    return isString(arg1)
      ? openlanAlert(arg0 as string, arg1, defaultProps)
      : openlanAlert(arg0 as string, { ...defaultProps, ...arg1 });
  }
  return openlanAlert(arg0 as string, arg1 as string, {
    ...defaultProps,
    ...arg2,
  });
}

export async function openlanPrompt<T = any>(
  ...
  staticContents.push(h(OpenLanRenderContent, { content, renderBr: true }));
