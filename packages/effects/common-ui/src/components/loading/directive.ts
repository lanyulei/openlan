...
import { OpenLanLoading, OpenLanSpinner } from '@vben-core/shadcn-ui';
...
const loadingDirective: Directive = {
  mounted(el, binding) {
    const instance = h(OpenLanLoading, getOptions(binding));
    render(instance, el);
...
const spinningDirective: Directive = {
  mounted(el, binding) {
    const instance = h(OpenLanSpinner, getOptions(binding));
    render(instance, el);
